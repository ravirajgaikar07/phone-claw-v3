"""ClawVia entry point — starts FastAPI server + Telegram bot + scheduler."""
...
def main():
    ...
    try:
        ...
        log.info("Loaded %d MCP tools", mcp_count)
    except Exception as exc:
        log.error("Failed to load MCP servers: %s", exc, exc_info=True)
