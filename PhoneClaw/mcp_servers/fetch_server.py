...
enough of the MCP protocol for PhoneClaw's mcp_client.py to connect:

  initialize → tools/list → tools/call

Depends only on stdlib + `requests` (already in PhoneClaw's requirements).
...
_SERVER_INFO = {"name": "phoneclaw-fetch", "version": "1.0"}
_MAX_RESPONSE_SIZE = 100_000  # chars — keep LLM context sane
_DEFAULT_TIMEOUT = 30
_DEFAULT_USER_AGENT = (
    "PhoneClaw-Fetch/1.0 (MCP; +https://github.com/yourname/PhoneClaw)"
)
